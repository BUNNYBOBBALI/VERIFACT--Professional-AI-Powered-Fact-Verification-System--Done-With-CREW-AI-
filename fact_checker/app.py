...
# Page configuration
st.set_page_config(
    page_title="VERIFACT - A PROJECT DONE BY BUNNY BOBBALI",
    layout="wide",
    page_icon="🔍",
...
try:
    ...
    st.image("src/fact_checker/assets/crewai_logo.png", width=300)
...
">
    <a href="mailto:bunnybobbali@gmail.com" style="
        color: white !important;
